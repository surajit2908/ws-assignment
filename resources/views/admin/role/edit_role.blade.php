    ...
    <div class="admin-body-area">
        ...
        <div class="booking-status-sec category-list-sec">
            ...
            <div class="category-list-area">
                <form action="{{ route('admin.role.update', $dataArr['roleArr']->id) }}" method="POST" id="role_form"
                    ...
                    <div class="midform">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="role_name" class="form-control"
                                value="{{ $dataArr['roleArr']->role_name }}" required="">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="my_select_box" multiple data-placeholder="Select Your Options"
                                ...
                                @foreach ($dataArr['permissionArr'] as $permission)
                                    <option value="{{ $permission->id }}"
                                        {{ in_array($permission->id, $dataArr['rolePermissionArr']) ? 'selected' : '' }}>
                                        {{ $permission->module_name }}</option>
                                @endforeach
                            </select>
                        </div>
